...
const Layout: React.FC<LayoutProps> = ({ children, currentPage }) => {
  ...
  return (
    <div key={location.pathname} className="flex h-screen overflow-hidden font-nohemi bg-gray-100 dark:bg-gray-900">
        ...
        <div className="w-68 bg-color-5 dark:bg-gray-800 shadow-lg flex flex-col">
          <div className="flex items-center justify-center h-16 px-4 mt-4">
            <div className="-translate-x-18">
              ...
              <img src="src/assets/Images/MedSov.jpeg" alt="MedSov Logo" className="w-30 h-6 fill-current text-primary translate-x-8" />
            </div>
            <div className="flex -translate-x-5 mt-1">
