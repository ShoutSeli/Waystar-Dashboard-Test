...
const Layout: React.FC<LayoutProps> = ({ children, currentPage }) => {
  ...
  const navItems = [
    ...
    { name: "Insurance/Payer View", path: "/payer" },
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-100">
      ...
      {/* Page Content */}
      <main className="flex-grow pt-24 px-4 sm:px-6">{children}</main>

      {/* Footer */}
      <footer className="bg-white shadow-inner py-4 mt-10">
        <div className="max-w-7xl mx-auto px-4 text-center text-gray-600 text-sm sm:text-base">
